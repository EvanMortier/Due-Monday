...
while 1:
    ...
    if answer =='park':
         ...
         if Fvol and Bvol >=33: #foward until distance ping for ultrasonic Evan Edit- Why was it less than, now greater than Also value should equal width of car in inches
             stop()
             time.sleep(.1)
             forward()
